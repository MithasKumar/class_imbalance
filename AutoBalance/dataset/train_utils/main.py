...
# **************** Some Relevant Paths **************************
root_path = "/home/ece/Lakshya/Projects/prj_imb/Final_DIR_SITARAM/Final_DIR_SITARAM" # CHANGE THIS TO Appropriate ROOT PATH
...
global_configs = {}
global_configs['Source_configs_path'] = os.path.join(data_path,'BP09_2019_configs.json')
global_configs['Target_configs_path'] = os.path.join(data_path,'da_target_configs.json')
global_configs['Source_train_data_path'] = os.path.join(data_path,'BP09_2019_train.feather')
global_configs['Source_eval_data_path'] = os.path.join(data_path,'BP09_2019_eval.feather')
global_configs['Source_test_data_path'] = os.path.join(data_path,'BP09_2019_test.feather')
