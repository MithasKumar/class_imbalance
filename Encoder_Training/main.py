...
if not just_infer:
    if args.train_mode=="Source_pipeline":
        Encoder_src,Decoder,Classifier = train_procedures.train_source_pipeline(Encoder_src=Encoder_src,Decoder_src=Decoder,Classifier=Classifier,configs=global_configs)
    elif args.train_mode=="Target_pipeline":
